...
BEGIN
	...
	SELECT 11, 'Red Field', 'Jorge Amado published Red Field in 1946. In 1945, Brazil had entered a period of “redemocratization” and Amado was elected federal deputy for S?o Paulo as a candidate of the Brazilian Communist Party.', 5 UNION

	SELECT 12, 'The Double Flame', NULL, 6 UNION

	SELECT 13, 'Solaris', 'Solaris is a 1961 science fiction novel by Polish writer Stanis³aw Lem. It follows a crew of scientists on a research station as they attempt to understand an extraterrestrial intelligence, which takes the form of a vast ocean on the titular alien planet. The novel is one of Lem"s best-known works.', 7 UNION
	SELECT 14, 'Fables for Robots', 'Fables for Robots is a series of humorous science fiction short stories by Polish writer Stanis³aw Lem, first printed in 1964.', 7 UNION
	SELECT 15, 'The Futurological Congress', 'a 1971 black humour science fiction novel by Polish author Stanis³aw Lem. It details the exploits of the hero of a number of his stories, Ijon Tichy, as he visits the Eighth World Futurological Congress at a Hilton Hotel in Costa Rica.', 7 UNION
